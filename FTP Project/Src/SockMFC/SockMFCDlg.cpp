...
CSockMFCDlg::CSockMFCDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_SOCKMFC_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CSockMFCDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CSockMFCDlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// CSockMFCDlg 메시지 처리기

BOOL CSockMFCDlg::OnInitDialog()
{
...
void CSockMFCDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CSockMFCDlg::OnQueryDragIcon()
{
