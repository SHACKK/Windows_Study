...
void CHangulCharset::Update(int nVirtualKey, ST_STRING_CONTEXT& context, bool bShiftPressed, bool bCapsLockPressed)
{
	__super::Update(nVirtualKey, context, bShiftPressed, bCapsLockPressed);
